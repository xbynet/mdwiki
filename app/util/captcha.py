#copy from https://github.com/ppgoodman/captcha
#!/usr/bin/python
#build by evan
#-*- coding=utf-8 -*-
import os,sys
...
FONT_PATH=os.path.abspath(os.path.join(curDir,'..','static','fonts','DroidSansMono.ttf'))


def createCaptcha(size=(180, 50),
                         chars=init_chars,
                         img_type="JPG",
                         mode="RGBA",
